...
/** Dummy Output Format Class so Hive will allow Example file tables */
public class ExampleScannerOutputFormat<K
  extends WritableComparable<K>, V extends Writable>
